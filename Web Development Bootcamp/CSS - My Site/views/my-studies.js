...
<div class="skills">
    ...
    <div class="skill-row">
        ...
        <p>In 2021 I enrolled in the Software Engineering program at SoftUni with C#. Throughout the courses I've
            learnt about linear data structures, multidimentional and associative arrays. Also, how to work with
    ...
    <div class="skill-row">
        ...
        <p>As part of the Software Engineering program I've completed the JS Advanced module in which I've learnt
            about DOM Manipulation and Events, HTTP Requests and REST Services as well as asynchronous programming and
            how to create Single-Page Applicaions using Javascript.</p>
    </div>
    <div class="skill-row">
        ...
        <p>Currently I'm enrolled in the C# Database module where we learn how to work with relational databases,
            how to manipulate, save and extract data. In the second module of this course I'll be learning Entity
            Framework Core.</p>
    </div>
    <div class="skill-row">
        <img class="chip-img" src="images/browser.png" alt="">
        <h3>HTML and CSS</h3>
        <p>Although not part of the main SoftUni program of Software Engineering I've learnt basic html and css
            through some Udemy courses and a lot of YouTube and Google so I can create this page. I found that I
            really like creating something visually beautiful and I'd really like to learn more of these technologies.
        </p>
    </div>
</div>
<hr>
